...
export function AddEditConnectionForm({ mode }: AddEditConnectionFormProps): JSX.Element {
  ...
  // Role-gate hint: Viewers cannot call /api/notes/generate (the
  // backend would return 403). Hide the button entirely; backend
  // RBAC is authoritative per AAP Sec 0.7.1.
  const canGenerateAi = hasRole("Admin") || hasRole("Contributor");
